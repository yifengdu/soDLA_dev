...
val last_entries = RegInit("b0".asUInt(conf.CSC_ENTRIES_NUM_WIDTH.W))
...
val h_bias_0_w = (datain_h_cnt(13, 0) * h_bias_0_stride)(conf.CBUF_ADDR_WIDTH-1, 0)
...
///// sideband pipeline                                  /////
//////////////////////////////////////////////////////////////
val dat_req_sub_h_addr = RegInit(VecInit(Seq.fill(4)(VecInit(Seq.fill(conf.CBUF_ADDR_WIDTH)(true.B)).asUInt)))
val sc2buf_dat_rd_en_out = RegInit(false.B)
val sc2buf_dat_rd_addr_out = RegInit(VecInit(Seq.fill(conf.CBUF_ADDR_WIDTH)(true.B)).asUInt)
