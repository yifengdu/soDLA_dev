...
// class NV_NVDLA_CSC_wl_gateIO(implicit conf: nvdlaConfig) extends Bundle{
...
//     val sc2mac_wt_a = ValidIO(new csc2cmac_wt_gold_if)     /* data valid */
//     val sc2mac_wt_b = ValidIO(new csc2cmac_wt_gold_if)     /* data valid */
...
// class NV_NVDLA_CSC_wl_gate(implicit val conf: nvdlaConfig) extends Module {
//     val io = IO(new NV_NVDLA_CSC_wl_gateIO)
//     //     
//     //          ┌─┐       ┌─┐
//     //       ┌──┘ ┴───────┘ ┴──┐
//     //       │                 │
...
// object NV_NVDLA_CSC_wl_gateDriver extends App {
//   implicit val conf: nvdlaConfig = new nvdlaConfig
//   chisel3.Driver.execute(args, () => new NV_NVDLA_CSC_wl_gate)
// }
