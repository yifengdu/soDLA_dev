...
class NV_NVDLA_CACC_calculator_bd(useRealClock:Boolean = false)(implicit val conf: nvdlaConfig) extends Module {
...
val bd = withClock(internal_clock){new bdImpl} 

}


object NV_NVDLA_CACC_calculator_bdDriver extends App {
  implicit val conf: nvdlaConfig = new nvdlaConfig
  chisel3.Driver.execute(args, () => new NV_NVDLA_CACC_calculator_bd())
}
