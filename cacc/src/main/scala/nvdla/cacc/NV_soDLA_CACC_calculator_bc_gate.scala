...
@chiselName
class NV_soDLA_CACC_calculator_bc_gate(implicit val conf: nvdlaConfig) extends Module {
...
object NV_soDLA_CACC_calculator_bc_gateDriver extends App {
  implicit val conf: nvdlaConfig = new nvdlaConfig
  chisel3.Driver.execute(args, () => new NV_soDLA_CACC_calculator_bc_gate())
}
