...
@chiselName
class NV_soDLA_CACC_delivery_ctrl_gate(implicit conf: caccConfiguration) extends Module {
...
object NV_soDLA_CACC_delivery_ctrl_gateDriver extends App {
  implicit val conf: nvdlaConfig = new nvdlaConfig
  chisel3.Driver.execute(args, () => new NV_soDLA_CACC_delivery_ctrl_gate())
}
